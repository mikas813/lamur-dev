...
class Google_Service_CloudDomains_RetrieveRegisterParametersResponse extends Google_Model
{
   ...
   */
  public function setRegisterParameters(Google_Service_CloudDomains_RegisterParameters $registerParameters)
  {

...
class Google_Service_CloudTalentSolution_GoogleCloudTalentV4CompensationInfoCompensationEntry extends Google_Model
{
  protected $amountType = 'Google_Service_CloudTalentSolution_Money';
  protected $amountDataType = '';
  public $description;
  public $expectedUnitsPerYear;
  protected $rangeType = 'Google_Service_CloudTalentSolution_GoogleCloudTalentV4CompensationInfoCompensationRange';
   ...
   */
  public function setRange(Google_Service_CloudTalentSolution_GoogleCloudTalentV4CompensationInfoCompensationRange $range)
  {
    $this->range = $range;
  }
  /**

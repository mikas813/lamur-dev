...
class Google_Service_CloudFilestore_UpdatePolicy extends Google_Collection
{
  protected $collection_key = 'denyMaintenancePeriods';
  public $channel;
  protected $denyMaintenancePeriodsType = 'Google_Service_CloudFilestore_DenyMaintenancePeriod';
  protected $denyMaintenancePeriodsDataType = 'array';
  protected $windowType = 'Google_Service_CloudFilestore_MaintenanceWindow';
   ...
   */
  public function setWindow(Google_Service_CloudFilestore_MaintenanceWindow $window)
  {
    $this->window = $window;
  }
  /**
   * @return Google_Service_CloudFilestore_MaintenanceWindow
   */

...
class Google_Service_CloudDatabaseMigrationService_ListMigrationJobsResponse extends Google_Collection
{
  protected $collection_key = 'unreachable';
  protected $migrationJobsType = 'Google_Service_CloudDatabaseMigrationService_MigrationJob';

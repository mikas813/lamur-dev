...
class Google_Service_CloudDatabaseMigrationService_ListConnectionProfilesResponse extends Google_Collection
{
  protected $collection_key = 'unreachable';
  protected $connectionProfilesType = 'Google_Service_CloudDatabaseMigrationService_ConnectionProfile';

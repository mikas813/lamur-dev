...
class Google_Service_CloudDatabaseMigrationService_SqlIpConfig extends Google_Collection
{
  protected $collection_key = 'authorizedNetworks';
  protected $authorizedNetworksType = 'Google_Service_CloudDatabaseMigrationService_SqlAclEntry';

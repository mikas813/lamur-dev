...
class Google_Service_CloudDatabaseMigrationService_Policy extends Google_Collection
{
  protected $collection_key = 'bindings';
  protected $auditConfigsType = 'Google_Service_CloudDatabaseMigrationService_AuditConfig';
  protected $auditConfigsDataType = 'array';
  protected $bindingsType = 'Google_Service_CloudDatabaseMigrationService_Binding';

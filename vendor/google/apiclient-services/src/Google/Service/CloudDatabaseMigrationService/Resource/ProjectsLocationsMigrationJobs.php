 ...
 * Typical usage is:
 *  <code>
 *   $datamigrationService = new Google_Service_CloudDatabaseMigrationService(...);
 *   $migrationJobs = $datamigrationService->migrationJobs;
 *  </code>
 */
class Google_Service_CloudDatabaseMigrationService_Resource_ProjectsLocationsMigrationJobs extends Google_Service_Resource
{
  /**
  ...
  public function create($parent, Google_Service_CloudDatabaseMigrationService_MigrationJob $postBody, $optParams = array())
  {
    ...
    return $this->call('create', array($params), "Google_Service_CloudDatabaseMigrationService_Operation");
  }
  /**
  ...
  public function delete($name, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), "Google_Service_CloudDatabaseMigrationService_Operation");
  }
  /**
   ...
   * the SSH script.
   * @param Google_Service_CloudDatabaseMigrationService_GenerateSshScriptRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_CloudDatabaseMigrationService_SshScript
   */
  public function generateSshScript($migrationJob, Google_Service_CloudDatabaseMigrationService_GenerateSshScriptRequest $postBody, $optParams = array())
  {
    $params = array('migrationJob' => $migrationJob, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('generateSshScript', array($params), "Google_Service_CloudDatabaseMigrationService_SshScript");
  }
  /**
  ...
  public function get($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Google_Service_CloudDatabaseMigrationService_MigrationJob");
  }
  /**
   ...
   * policies).
   * @return Google_Service_CloudDatabaseMigrationService_Policy
   */
  public function getIamPolicy($resource, $optParams = array())
  {
    $params = array('resource' => $resource);
    $params = array_merge($params, $optParams);
    return $this->call('getIamPolicy', array($params), "Google_Service_CloudDatabaseMigrationService_Policy");
  }
  /**
  ...
  public function listProjectsLocationsMigrationJobs($parent, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_CloudDatabaseMigrationService_ListMigrationJobsResponse");
  }
  /**
   ...
   * @return Google_Service_CloudDatabaseMigrationService_Operation
   */
  public function patch($name, Google_Service_CloudDatabaseMigrationService_MigrationJob $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Google_Service_CloudDatabaseMigrationService_Operation");
  }
  /**
   ...
   * @param Google_Service_CloudDatabaseMigrationService_PromoteMigrationJobRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_CloudDatabaseMigrationService_Operation
   */
  public function promote($name, Google_Service_CloudDatabaseMigrationService_PromoteMigrationJobRequest $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('promote', array($params), "Google_Service_CloudDatabaseMigrationService_Operation");
  }
  /**
   ...
   * @param Google_Service_CloudDatabaseMigrationService_RestartMigrationJobRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_CloudDatabaseMigrationService_Operation
   */
  public function restart($name, Google_Service_CloudDatabaseMigrationService_RestartMigrationJobRequest $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('restart', array($params), "Google_Service_CloudDatabaseMigrationService_Operation");
  }
  /**
   ...
   * @param Google_Service_CloudDatabaseMigrationService_ResumeMigrationJobRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_CloudDatabaseMigrationService_Operation
   */
  public function resume($name, Google_Service_CloudDatabaseMigrationService_ResumeMigrationJobRequest $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('resume', array($params), "Google_Service_CloudDatabaseMigrationService_Operation");
  }
  /**
   ...
   * field.
   * @param Google_Service_CloudDatabaseMigrationService_SetIamPolicyRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_CloudDatabaseMigrationService_Policy
   */
  public function setIamPolicy($resource, Google_Service_CloudDatabaseMigrationService_SetIamPolicyRequest $postBody, $optParams = array())
  {
    $params = array('resource' => $resource, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('setIamPolicy', array($params), "Google_Service_CloudDatabaseMigrationService_Policy");
  }
  /**
   * Start an already created migration job. (migrationJobs.start)
   *
   * @param string $name Name of the migration job resource to start.
   * @param Google_Service_CloudDatabaseMigrationService_StartMigrationJobRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_CloudDatabaseMigrationService_Operation
   */
  public function start($name, Google_Service_CloudDatabaseMigrationService_StartMigrationJobRequest $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('start', array($params), "Google_Service_CloudDatabaseMigrationService_Operation");
  }
  /**
   * Stops a running migration job. (migrationJobs.stop)
   *
   * @param string $name Name of the migration job resource to stop.
   * @param Google_Service_CloudDatabaseMigrationService_StopMigrationJobRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_CloudDatabaseMigrationService_Operation
   */
  public function stop($name, Google_Service_CloudDatabaseMigrationService_StopMigrationJobRequest $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('stop', array($params), "Google_Service_CloudDatabaseMigrationService_Operation");
  }
  /**
   ...
   * for this field.
   * @param Google_Service_CloudDatabaseMigrationService_TestIamPermissionsRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_CloudDatabaseMigrationService_TestIamPermissionsResponse
   */
  public function testIamPermissions($resource, Google_Service_CloudDatabaseMigrationService_TestIamPermissionsRequest $postBody, $optParams = array())
  {
    $params = array('resource' => $resource, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('testIamPermissions', array($params), "Google_Service_CloudDatabaseMigrationService_TestIamPermissionsResponse");
  }
  /**
   ...
   * @param Google_Service_CloudDatabaseMigrationService_VerifyMigrationJobRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_CloudDatabaseMigrationService_Operation
   */
  public function verify($name, Google_Service_CloudDatabaseMigrationService_VerifyMigrationJobRequest $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('verify', array($params), "Google_Service_CloudDatabaseMigrationService_Operation");
  }
}

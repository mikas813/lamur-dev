 ...
 *  </code>
 */
class Google_Service_CloudDatabaseMigrationService_Resource_ProjectsLocationsConnectionProfiles extends Google_Service_Resource
{
  /**
   ...
   */
  public function create($parent, Google_Service_CloudDatabaseMigrationService_ConnectionProfile $postBody, $optParams = array())
  {
  ...
  public function get($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Google_Service_CloudDatabaseMigrationService_ConnectionProfile");
  }
  /**
  ...
  public function listProjectsLocationsConnectionProfiles($parent, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_CloudDatabaseMigrationService_ListConnectionProfilesResponse");
  }
  /**

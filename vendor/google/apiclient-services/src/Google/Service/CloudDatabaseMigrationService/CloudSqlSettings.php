...
class Google_Service_CloudDatabaseMigrationService_CloudSqlSettings extends Google_Model
{
  ...
  protected $ipConfigType = 'Google_Service_CloudDatabaseMigrationService_SqlIpConfig';
  ...
  /**
   * @param Google_Service_CloudDatabaseMigrationService_SqlIpConfig
   */
  public function setIpConfig(Google_Service_CloudDatabaseMigrationService_SqlIpConfig $ipConfig)
  {
    $this->ipConfig = $ipConfig;
  }
  /**
   * @return Google_Service_CloudDatabaseMigrationService_SqlIpConfig
   */

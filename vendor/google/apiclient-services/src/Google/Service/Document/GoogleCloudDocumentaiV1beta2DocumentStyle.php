...
class Google_Service_Document_GoogleCloudDocumentaiV1beta2DocumentStyle extends Google_Model
{
  ...
  protected $fontSizeType = 'Google_Service_Document_GoogleCloudDocumentaiV1beta2DocumentStyleFontSize';
  ...
  /**
   * @param Google_Service_Document_GoogleCloudDocumentaiV1beta2DocumentStyleFontSize
   */
  public function setFontSize(Google_Service_Document_GoogleCloudDocumentaiV1beta2DocumentStyleFontSize $fontSize)
  {
    $this->fontSize = $fontSize;
  }
  /**
   * @return Google_Service_Document_GoogleCloudDocumentaiV1beta2DocumentStyleFontSize
   */

...
class Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentStyle extends Google_Model
{
  ...
  protected $fontSizeType = 'Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentStyleFontSize';
  ...
  /**
   * @param Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentStyleFontSize
   */
  public function setFontSize(Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentStyleFontSize $fontSize)
  {
    $this->fontSize = $fontSize;
  }
  /**
   * @return Google_Service_Document_GoogleCloudDocumentaiV1beta3DocumentStyleFontSize
   */

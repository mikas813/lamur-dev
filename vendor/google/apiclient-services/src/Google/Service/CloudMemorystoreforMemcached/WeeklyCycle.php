...
class Google_Service_CloudMemorystoreforMemcached_WeeklyCycle extends Google_Collection
{
  protected $collection_key = 'schedule';
  protected $scheduleType = 'Google_Service_CloudMemorystoreforMemcached_Schedule';

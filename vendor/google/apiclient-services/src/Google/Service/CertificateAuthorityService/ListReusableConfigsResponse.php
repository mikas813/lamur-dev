...
class Google_Service_CertificateAuthorityService_ListReusableConfigsResponse extends Google_Collection
{
  protected $collection_key = 'unreachable';
  public $nextPageToken;
  protected $reusableConfigsType = 'Google_Service_CertificateAuthorityService_ReusableConfig';
  protected $reusableConfigsDataType = 'array';
  public $unreachable;

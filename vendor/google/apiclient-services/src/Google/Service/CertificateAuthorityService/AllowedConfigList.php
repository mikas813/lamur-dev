...
class Google_Service_CertificateAuthorityService_AllowedConfigList extends Google_Collection
{
  protected $collection_key = 'allowedConfigValues';
  protected $allowedConfigValuesType = 'Google_Service_CertificateAuthorityService_ReusableConfigWrapper';

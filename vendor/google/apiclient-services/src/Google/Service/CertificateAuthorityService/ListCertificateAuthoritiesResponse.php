...
class Google_Service_CertificateAuthorityService_ListCertificateAuthoritiesResponse extends Google_Collection
{
  protected $collection_key = 'unreachable';
  protected $certificateAuthoritiesType = 'Google_Service_CertificateAuthorityService_CertificateAuthority';

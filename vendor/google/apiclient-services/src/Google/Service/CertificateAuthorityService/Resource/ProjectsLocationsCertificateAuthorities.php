 ...
 *  </code>
 */
class Google_Service_CertificateAuthorityService_Resource_ProjectsLocationsCertificateAuthorities extends Google_Service_Resource
{
  /**
   ...
   * @return Google_Service_CertificateAuthorityService_Operation
   */
  public function restore($name, Google_Service_CertificateAuthorityService_RestoreCertificateAuthorityRequest $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('restore', array($params), "Google_Service_CertificateAuthorityService_Operation");
  }
  /**
   ...
   * @return Google_Service_CertificateAuthorityService_Operation
   */
  public function scheduleDelete($name, Google_Service_CertificateAuthorityService_ScheduleDeleteCertificateAuthorityRequest $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('scheduleDelete', array($params), "Google_Service_CertificateAuthorityService_Operation");
  }
  /**

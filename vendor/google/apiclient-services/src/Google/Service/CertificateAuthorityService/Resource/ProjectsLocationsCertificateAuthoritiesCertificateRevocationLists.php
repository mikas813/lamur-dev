 ...
 *  </code>
 */
class Google_Service_CertificateAuthorityService_Resource_ProjectsLocationsCertificateAuthoritiesCertificateRevocationLists extends Google_Service_Resource
{
  /**
   ...
   * ationsCertificateAuthoritiesCertificateRevocationLists)
   *
   ...
   */
  public function listProjectsLocationsCertificateAuthoritiesCertificateRevocationLists($parent, $optParams = array())
  {
   ...
   *
   * @param string $name Output only. The resource path for this

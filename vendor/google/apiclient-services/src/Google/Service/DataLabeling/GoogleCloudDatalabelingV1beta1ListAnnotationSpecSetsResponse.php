...
class Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1ListAnnotationSpecSetsResponse extends Google_Collection
{
  protected $collection_key = 'annotationSpecSets';
  protected $annotationSpecSetsType = 'Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1AnnotationSpecSet';

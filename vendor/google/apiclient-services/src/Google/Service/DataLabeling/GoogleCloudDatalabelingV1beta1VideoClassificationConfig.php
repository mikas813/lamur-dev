...
class Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1VideoClassificationConfig extends Google_Collection
{
  protected $collection_key = 'annotationSpecSetConfigs';
  protected $annotationSpecSetConfigsType = 'Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1AnnotationSpecSetConfig';

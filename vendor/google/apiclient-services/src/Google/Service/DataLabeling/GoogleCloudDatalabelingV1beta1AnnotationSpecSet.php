...
class Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1AnnotationSpecSet extends Google_Collection
{
  protected $collection_key = 'blockingResources';
  protected $annotationSpecsType = 'Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1AnnotationSpec';

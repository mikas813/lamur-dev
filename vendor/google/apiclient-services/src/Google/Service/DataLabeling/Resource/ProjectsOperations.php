 ...
 *  </code>
 */
class Google_Service_DataLabeling_Resource_ProjectsOperations extends Google_Service_Resource
{
  /**
  ...
  public function cancel($name, $optParams = array())
  {
    ...
    return $this->call('cancel', array($params), "Google_Service_DataLabeling_GoogleProtobufEmpty");
  }
  /**
  ...
  public function get($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Google_Service_DataLabeling_GoogleLongrunningOperation");
  }
  /**
   ...
   * @return Google_Service_DataLabeling_GoogleLongrunningListOperationsResponse
   */
  public function listProjectsOperations($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_DataLabeling_GoogleLongrunningListOperationsResponse");
  }
}

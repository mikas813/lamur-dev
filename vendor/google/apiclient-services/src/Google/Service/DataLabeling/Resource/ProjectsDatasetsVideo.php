 ...
 *  </code>
 */
class Google_Service_DataLabeling_Resource_ProjectsDatasetsVideo extends Google_Service_Resource
{
  /**
   ...
   * @param Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1LabelVideoRequest $postBody
   * @param array $optParams Optional parameters.
   * @return Google_Service_DataLabeling_GoogleLongrunningOperation
   */
  public function label($parent, Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1LabelVideoRequest $postBody, $optParams = array())
  {

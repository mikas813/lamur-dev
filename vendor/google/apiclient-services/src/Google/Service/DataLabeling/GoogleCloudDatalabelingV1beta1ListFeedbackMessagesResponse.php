...
class Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1ListFeedbackMessagesResponse extends Google_Collection
{
  protected $collection_key = 'feedbackMessages';
  protected $feedbackMessagesType = 'Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1FeedbackMessage';

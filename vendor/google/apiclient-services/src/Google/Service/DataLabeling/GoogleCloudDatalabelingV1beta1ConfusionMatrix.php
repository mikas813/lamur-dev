...
class Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1ConfusionMatrix extends Google_Collection
{
  protected $collection_key = 'row';
  protected $rowType = 'Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1Row';

...
class Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1ListFeedbackThreadsResponse extends Google_Collection
{
  protected $collection_key = 'feedbackThreads';
  protected $feedbackThreadsType = 'Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1FeedbackThread';

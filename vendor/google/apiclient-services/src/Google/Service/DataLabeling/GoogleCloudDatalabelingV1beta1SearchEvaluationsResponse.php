...
class Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1SearchEvaluationsResponse extends Google_Collection
{
  protected $collection_key = 'evaluations';
  protected $evaluationsType = 'Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1Evaluation';

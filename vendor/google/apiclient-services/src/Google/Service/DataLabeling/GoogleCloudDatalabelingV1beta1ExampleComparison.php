...
class Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1ExampleComparison extends Google_Collection
{
  protected $collection_key = 'modelCreatedExamples';
  protected $groundTruthExampleType = 'Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1Example';
  protected $groundTruthExampleDataType = '';
  protected $modelCreatedExamplesType = 'Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1Example';
  protected $modelCreatedExamplesDataType = 'array';

  /**
   * @param Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1Example
   */
  public function setGroundTruthExample(Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1Example $groundTruthExample)
  {

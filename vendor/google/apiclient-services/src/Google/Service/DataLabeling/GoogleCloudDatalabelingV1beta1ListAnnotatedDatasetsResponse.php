...
class Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1ListAnnotatedDatasetsResponse extends Google_Collection
{
  protected $collection_key = 'annotatedDatasets';
  protected $annotatedDatasetsType = 'Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1AnnotatedDataset';

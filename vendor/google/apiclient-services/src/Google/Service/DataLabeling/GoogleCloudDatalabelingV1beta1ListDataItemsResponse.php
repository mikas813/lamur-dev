...
class Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1ListDataItemsResponse extends Google_Collection
{
  protected $collection_key = 'dataItems';
  protected $dataItemsType = 'Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1DataItem';

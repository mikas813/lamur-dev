...
class Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1ListEvaluationJobsResponse extends Google_Collection
{
  protected $collection_key = 'evaluationJobs';
  protected $evaluationJobsType = 'Google_Service_DataLabeling_GoogleCloudDatalabelingV1beta1EvaluationJob';

...
class Google_Service_DisplayVideo_ListManualTriggersResponse extends Google_Collection
{
  protected $collection_key = 'manualTriggers';
  protected $manualTriggersType = 'Google_Service_DisplayVideo_ManualTrigger';

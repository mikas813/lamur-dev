...
class Google_Service_CloudBillingBudget_GoogleCloudBillingBudgetsV1BudgetAmount extends Google_Model
{
  protected $lastPeriodAmountType = 'Google_Service_CloudBillingBudget_GoogleCloudBillingBudgetsV1LastPeriodAmount';
  ...
  /**
   * @param Google_Service_CloudBillingBudget_GoogleCloudBillingBudgetsV1LastPeriodAmount
   */
  public function setLastPeriodAmount(Google_Service_CloudBillingBudget_GoogleCloudBillingBudgetsV1LastPeriodAmount $lastPeriodAmount)
  {

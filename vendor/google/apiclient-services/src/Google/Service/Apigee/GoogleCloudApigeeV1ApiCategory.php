...
class Google_Service_Apigee_GoogleCloudApigeeV1ApiCategory extends Google_Model
{
   ...
   */
  public function setData(Google_Service_Apigee_GoogleCloudApigeeV1ApiCategoryData $data)
  {
    $this->data = $data;
  }
  /**

 ...
 *  </code>
 */
class Google_Service_Apigee_Resource_OrganizationsDatacollectors extends Google_Service_Resource
{
  /**
   ...
   */
  public function create($parent, Google_Service_Apigee_GoogleCloudApigeeV1DataCollector $postBody, $optParams = array())
  {
    $params = array('parent' => $parent, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('create', array($params), "Google_Service_Apigee_GoogleCloudApigeeV1DataCollector");
  }
  /**
  ...
  public function get($name, $optParams = array())
  {
    $params = array('name' => $name);
    $params = array_merge($params, $optParams);
    return $this->call('get', array($params), "Google_Service_Apigee_GoogleCloudApigeeV1DataCollector");
  }
  /**
  ...
  public function listOrganizationsDatacollectors($parent, $optParams = array())
  {
    ...
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_Apigee_GoogleCloudApigeeV1ListDataCollectorsResponse");
  }
  /**
   ...
   * @return Google_Service_Apigee_GoogleCloudApigeeV1DataCollector
   */
  public function patch($name, Google_Service_Apigee_GoogleCloudApigeeV1DataCollector $postBody, $optParams = array())
  {
    $params = array('name' => $name, 'postBody' => $postBody);
    $params = array_merge($params, $optParams);
    return $this->call('patch', array($params), "Google_Service_Apigee_GoogleCloudApigeeV1DataCollector");
  }
}

...
class Google_Service_CloudAsset_WindowsUpdatePackage extends Google_Collection
{
  protected $collection_key = 'moreInfoUrls';
  protected $categoriesType = 'Google_Service_CloudAsset_WindowsUpdateCategory';
